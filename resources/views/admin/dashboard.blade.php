    ...
    <main class="nxl-container">
        <div class="nxl-content">
            ...
            <div class="main-content">
                <div class="row">
                    <!-- [Invoices Awaiting Payment] start -->@foreach ($packages as $package)
                                    ...
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div>
                                            <div class="fs-4 fw-bold text-dark">
                                                <span class="counter">{{ $package->package_name }}</span>
                                            </div>
...
<script src="{{ asset('build/assets/vendors/js/daterangepicker.min.js') }}"></script>
<script src="{{ asset('build/assets/vendors/js/apexcharts.min.js') }}"></script>
<script src="{{ asset('build/assets/vendors/js/circle-progress.min.js') }}"></script>
<!--! END: Vendors JS !-->
<!--! BEGIN: Apps Init  !-->
<script src="{{ asset('build/assets/js/common-init.min.js') }}"></script>
<script src="{{ asset('build/assets/js/dashboard-init.min.js') }}"></script>
<!--! END: Apps Init !-->
<!--! BEGIN: Theme Customizer  !-->
