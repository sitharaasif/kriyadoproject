<div>
    ...
    <div class="stepwizard">
        <div class="stepwizard-row setup-panel">
            ...
            <div class="stepwizard-step">
                <a href="#step-4" type="button" class="btn btn-circle <?php echo e($currentStep != 4 ? 'btn-default' : 'btn-primary'); ?>" disabled="disabled">4</a>
                <p>Step 4</p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('vendors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\KriyadoProject\resources\views/livewire/vendor.blade.php ENDPATH**/ ?>