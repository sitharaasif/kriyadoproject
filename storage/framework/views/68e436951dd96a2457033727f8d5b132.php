...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('build/assets/vendors/css/select2.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('build/assets/vendors/css/select2-theme.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('build/assets/vendors/css/jquery.steps.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('build/assets/vendors/css/quill.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('build/assets/vendors/css/datepicker.min.css')); ?>">
    <!--! END: Vendors CSS-->
...
<script src="<?php echo e(asset('build/assets/vendors/js/lslstrength.min.js')); ?>"></script>
<script src="<?php echo e(asset('build/assets/vendors/js/jquery.steps.min.js')); ?>"></script>
<script src="<?php echo e(asset('build/assets/vendors/js/jquery.validate.min.js')); ?>"></script>
<script src="<?php echo e(asset('build/assets/vendors/js/quill.min.js')); ?>"></script>
<script src="<?php echo e(asset('build/assets/vendors/js/datepicker.min.js')); ?>"></script>
<script src="<?php echo e(asset('build/assets/vendors/js/select2.min.js')); ?>"></script>
<script src="<?php echo e(asset('build/assets/vendors/js/select2-active.min.js')); ?>"></script>

<!--! END: Vendors JS !-->
<!--! BEGIN: Apps Init  !-->
<script src="<?php echo e(asset('build/assets/js/common-init.min.js')); ?>"></script>
<script src="<?php echo e(asset('build/assets/js/vendor-create-init.min.js')); ?>"></script>
<!--! END: Apps Init !-->
...
</html><?php /**PATH C:\wamp64\www\KriyadoProject\resources\views/vendor/stylevendor.blade.php ENDPATH**/ ?>